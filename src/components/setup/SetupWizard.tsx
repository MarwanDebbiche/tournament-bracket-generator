    ...
    <div>
              ...
              >
                <span
                  className={cn(
                    ...
                    !current && !done && 'bg-slate-100 text-slate-400 group-hover:bg-slate-200',
                  )}
                >
                ...
                <span
                  className={cn(
                    ...
                    current ? 'text-slate-900' : 'text-slate-400 group-hover:text-slate-600',
                  )}
                >
                  {label}
                </span>
      ...
      <div className="mt-6 flex items-center justify-between">
        <button
          ...
          disabled={step === 0}
          className="inline-flex items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium text-slate-600 transition hover:bg-slate-100 disabled:invisible"
        >
        ...
        {isLast ? (
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-500 disabled:cursor-not-allowed disabled:bg-slate-300 disabled:text-slate-500 disabled:shadow-none"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-slate-700"
          >
            Next
